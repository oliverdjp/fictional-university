  ...
  _createClass(MyNotes, [{
    ...
    value: function createNote(e) {
      ...
      _jquery2.default.ajax({
        ...
        data: ourNewPost,
        success: function success(response) {
          (0, _jquery2.default)(".new-note-tile, .new-note-body").val("");
          ...
          console.log('Congrats');
          console.log(response);
          (0, _jquery2.default)(".new-note-title").val("");
          (0, _jquery2.default)(".new-note-body").val("");
        },
        error: function error(response) {
...
var Search = function () {
  ...
  _createClass(Search, [{
    ...
    value: function openOverlay() {
      ...
      //Overlay takes 300ms to fade in. Timeout required for focus to take effect.
      setTimeout(function () {
