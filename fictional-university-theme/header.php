...
<html <?php language_attributes();?> >
  <head>
    <meta charset="<?php bloginfo('charset'); ?>" name="viewport" content="width=device-width, initial-scale=1.0">
    <?php wp_head(); ?>
  </head>
  <body <?php body_class(); ?>>
      ...
      <div class="container">
        ...
        <div class="site-header__menu group">
          <nav class="main-navigation">
            <!-- <?//php
              //Adding the menu created in the menu section in the admin dashboard.
              //wp_nav_menu(array(
              //  'theme_location' => 'headerMenuLocation'
              //));
            ?> -->
            <ul>
              <li <?php if(is_page('about-us') or wp_get_post_parent_id(0) == 38) echo 'class="current-menu-item"'; ?>><a href="<?php echo site_url('/about-us') ?>">About Us</a></li>
